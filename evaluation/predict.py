...
settings = SettingsWithValidation("data/test-jpg", "data/sample/valid", batch_size=40)
filenames, gen = evaluation_data(settings)
model = vgg16bn(settings.training_classes, weights_file="weights/weights.09-5.15.hdf5", trainable=False)
